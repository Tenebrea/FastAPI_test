...
SQLALCHEMY_DATABASE_URL = "mysql+pymysql://isp_p_Bulatov:12345@77.91.86.135/isp_p_Bulatov"
SECRET_KEY = "1c0918eebdadd1f0680ca267df7800a3359ad9eee4ba0d78eeb681846dead896"
ALGORITHM = "HS256"
...
def update_user(user_id: int, user_update: UserUpdate, token: Annotated[str, Depends(oauth2_scheme)], db: Session = Depends(get_db)):
    credentials_exception = HTTPException(
        status_code=status.HTTP_401_UNAUTHORIZED,
        detail="Could not validate credentials",
        headers={"WWW-Authenticate": "Bearer"},
